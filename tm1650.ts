...
namespace TM1650 {
     ...
     * turn on display
     */
    //% blockId="TM650_ON" block="encender display"
     ...
     * turn off display
     */
    //% blockId="TM650_OFF" block="apagar display"
    //% weight=50 blockGap=8
    export function off() {
        _intensity = 0
        cmd(0)
     ...
     */
    //% blockId="TM650_CLEAR" block="limpiar display"
     ...
     */
    //% blockId="TM650_DIGIT" block="mostrar digito %num|en %bit"
     ...
     */
    //% blockId="TM650_SHOW_NUMBER" block="mostrar numero %num"
    ...
    //% blockId="showSring" block="mostrar cadena %str"
    //% weight=100 blockGap=8
    ...
    //% blockId="showRunging" block="desplazar display %str | tiempo de desplazamiento(ms) %del"
     ...
     */
    //% blockId="TM650_SHOW_HEX_NUMBER" block="mostrar numero hexadecimal %num"
     ...
     */
    //% blockId="TM650_SHOW_DP" block="mostrar punto decimal %bit|mostrar %num"
     ...
     */
    //% blockId="TM650_INTENSITY" block="establecer intensidad %dat"
